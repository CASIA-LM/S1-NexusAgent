...
const AddTeam = ({ isOpen, onClose }: AddTeamProps) => {
  ...
  const cardIcons: CardIcons = {
    ...
    aip: {
      ...
      backgroundColor: "#ff5722",
      icon: <GiTeamIdea size="24" />,
      title: t("team.teamcard.aip.title"),
      descripthion: t("team.teamcard.aip.description"),
    },
    workflow_agent: {
      colorScheme: "red",
      backgroundColor: "#ff5722",
      icon: <GiTeamIdea size="24" />,
      title: t("team.teamcard.workflow_agent.title"),
      descripthion: t("team.teamcard.workflow_agent.description"),
    },
    multi_agent: {
      colorScheme: "pink",
      backgroundColor: "#f06595",
      icon: <GiTeamIdea size="24" />,
      title: t("team.teamcard.multiagent.title"),
      descripthion: t("team.teamcard.multiagent.description"),
    }
  };
                ...
                <FormControl isRequired isInvalid={!!errors.name} flex={1}>
                  <Input
                    {...register("name", {
                      ...
                      pattern: {
                        value: /^[a-zA-Z0-9\u4e00-\u9fff][a-zA-Z0-9_\u4e00-\u9fff-]{0,63}$/,
                        message:
                          "Name must follow pattern: ^[a-zA-Z0-9\u4e00-\u9fff][a-zA-Z0-9_\u4e00-\u9fff-]{0,63}$",
                      },
                    })}
